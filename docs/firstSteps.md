...
At a very basic level, SignalK can be considered a web-serever to host pages, and applications that you might develop as part of a marine navigation project or exercise.  
This repo was put together to help developers to build a SignalK web app, from scratch, from first-principles, ab-inito (whatever phrase you prefer).  
...
1. Frontend: **[index.html](../public/index.html)**  
